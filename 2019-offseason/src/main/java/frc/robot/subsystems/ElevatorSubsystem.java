...
public class ElevatorSubsystem extends SubsystemBase{
    ...
    private void zero() {
        ...
        m_talon.setSelectedSensorPosition((int)Math.round(Constants.DEGREES_ELEVATOR_SAFE_POINT * Constants.DEGREES_TO_TURRET_ENCODER), 0, Constants.TALON_TIMEOUT_MS);
        isZeroed = true;
    }
}
...
public final class Constants {
    ...
    public static double DRIVETRAIN_LEFT_KP = 1;
    public static double DRIVETRAIN_LEFT_KI = 0;
    public static double DRIVETRAIN_LEFT_KD = 0;

    public static double DRIVETRAIN_RIGHT_KP = 1;
